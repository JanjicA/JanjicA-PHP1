    ...
    <div class="container">
        <div class="row showdole">
            <div class="col-lg-12 col-md-12 novo">
                <h2 class="text-center"><b>MUST HAVE</b></h2>
            </div>
        </div>

		<?php
			$sviproizvpodi = $conn->query("SELECT * FROM proizvodi p INNER JOIN vrsta v ON p.idVrsta=v.id_vrsta WHERE v.id_vrsta=3")->fetchAll();
		?>
